...
public class LunchRoom
{
   ...
   public static PriorityQueue<Customer> pq = new PriorityQueue<Customer>();
   //numbers of customers by class
   public static int nse = 0;
   public static int nju = 0;
   public static int nso = 0;
   public static int nfr = 0;
   //running total wait times by class
   public static double setwt = 0.0;
   public static double jutwt = 0.0;
   public static double sotwt = 0.0;
   public static double frtwt = 0.0;
   //longest wait times by class
   public static int selw = 0;
   public static int julw = 0;
   public static int solw = 0;
   public static int frlw = 0;
   ...
   public static void main(String[] args)
   {
      ...
      System.out.println("Senior\t\t\t" + nse + "\t" + "\t" + "\t" + selw + "\t\t\t" + (setwt/nse));
      System.out.println("Junior\t\t\t" + nju + "\t" + "\t" + "\t" + julw + "\t\t\t" + (jutwt/nju));
      System.out.println("Sophomore\t\t" + nso + "\t" + "\t" + "\t" + solw + "\t" + "\t" + "\t" + (sotwt/nso));
      System.out.println("Freshman\t\t\t" + nfr + "\t" + "\t" + "\t" + frlw + "\t\t\t" + (frtwt/nfr));
   }
   ...
   public static Customer newCustomer(int a)
   {
      ...
      return new Customer(c, a);
   }
   
   public static void updateNC(Customer c)
   {
      String cy = c.getMyYear();
      switch(cy)
      {
         case "Se":
            nse++;
   ...
   public static void updateRT(Customer c, int a, int b)
   {
      String cy = c.getMyYear();
      int tba = a-b;
      switch(cy)
   ...
   public static void updateLW(Customer c, int a, int b)
   {
      String cy = c.getMyYear();
      int tba = a-b;
      switch(cy)
...
class Customer implements Comparable<Customer>
{
   ...
   public Customer(String year, int arrival)
   {
      myYear = year;
      myat = arrival;
   }
   ...
   {
      if(myYear.equals(obj.myYear))
         return (myat - obj.myat);
      if((myYear.equals("Se") || myYear.equals("Ju")) && (obj.myYear.equals("Fr") || obj.myYear.equals("So")))
         return -1;
      if((myYear.equals("So") || myYear.equals("Fr")) && (obj.myYear.equals("Se") || obj.myYear.equals("Ju")))
         return 1;
      if((myYear.equals("So") && obj.myYear.equals("Fr")) || (myYear.equals("Se") && obj.myYear.equals("Ju")))
         return -1;
      if((obj.myYear.equals("So") && myYear.equals("Fr")) || (obj.myYear.equals("Se") && myYear.equals("Ju")))
         return 1;
      else
         return 0;
   }
